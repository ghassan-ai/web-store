...
export const GridScan = ({
  ...
  useEffect(() => {
    ...
    const usePost = enablePost && !isMobile && !reducedMotion;
    ...
    requestAnimationFrame(() => container.classList.add('gridscan--ready'));
    ...
    if (reducedMotion) {
      material.uniforms.iTime.value = 0.5;
      ...
      return () => {
        ...
        if (composer) { composer.dispose(); composerRef.current = null; }
        renderer.dispose();
